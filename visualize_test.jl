...
folder = "final-gpu-4-cores-bounded/"

# u0gpu = jldopen(folder * "/variables_rank0.jld2")["uarr"];
# u1gpu = jldopen(folder * "/variables_rank1.jld2")["uarr"];
# u2gpu = jldopen(folder * "/variables_rank2.jld2")["uarr"];
# u3gpu = jldopen(folder * "/variables_rank3.jld2")["uarr"];

# η0gpu = jldopen(folder * "/variables_rank0.jld2")["ηarr"];
# η1gpu = jldopen(folder * "/variables_rank1.jld2")["ηarr"];
# η2gpu = jldopen(folder * "/variables_rank2.jld2")["ηarr"];
# η3gpu = jldopen(folder * "/variables_rank3.jld2")["ηarr"];

u0cpu = jldopen("variables_rank0.jld2")["uarr"];
u1cpu = jldopen("variables_rank1.jld2")["uarr"];
u2cpu = jldopen("variables_rank2.jld2")["uarr"];
u3cpu = jldopen("variables_rank3.jld2")["uarr"];

η0cpu = jldopen("variables_rank0.jld2")["ηarr"];
η1cpu = jldopen("variables_rank1.jld2")["ηarr"];
η2cpu = jldopen("variables_rank2.jld2")["ηarr"];
η3cpu = jldopen("variables_rank3.jld2")["ηarr"];
...
# lines!(ax, g1,  ηi1g, color = :blue, linestyle = :solid)
...
# lines!(ax, g2,  ηi2g, color = :blue, linestyle = :solid)
...
# lines!(ax, g3,  ηi3g, color = :blue, linestyle = :solid)
